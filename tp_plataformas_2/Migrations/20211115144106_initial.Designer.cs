...
namespace tp_plataformas_2.Migrations
{
    ...
    [Migration("20211115144106_initial")]
            ...
            modelBuilder.Entity("CompraProducto", b =>
                {
                    ...
                    b.Property<int>("CompraProductoProductoId")
                        .HasColumnType("int");

                    b.HasKey("CompraProductoCompraId", "CompraProductoProductoId");

                    b.HasIndex("CompraProductoProductoId");
            ...
            modelBuilder.Entity("CompraProducto", b =>
                {
                    ...
                    b.HasOne("tp_plataformas_2.Producto", null)
                        .WithMany()
                        .HasForeignKey("CompraProductoProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
